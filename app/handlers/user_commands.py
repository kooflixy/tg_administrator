...
<code>/local</code> <b>[id пользователя]</b> - блокирует пользователя по всей сети чатов без уведомления

<code>/unlocal</code> <b>[id пользователя]</b> - разблокирует пользователя по всей сети чатов без уведомления
...
Текст кнопок и сообщений меняется в настройках капчи
...
{user} - отметка пользователя
{reason} - причина бана
{proof} - доказательства/ссылка на канал с банами

<code>/set_ba_post</code> <b>[новый текст сообщения]</b> - изменение поста в канал при бане по сети
<i>{user_id}, {user}, {reason}, {proof}</i>

<code>/set_ba_text</code> <b>[новый текст сообщения]</b> - изменение текста уведомления о бане по сети
<i>{user}, {proof}</i> 

<code>/set_unba_text</code> <b>[новый текст сообщения]</b> - изменение текста уведомления о разбане по сети
<i>{user}, {proof}</i>
